...
function showContent(faqBlock){
    const openBlocks = document.getElementsByClassName("openFaq")
    ...
    if (faqBlock.classList.contains("openFaq")){
        faqBlock.classList.remove("openFaq")
    }
        else{
                while (openBlocks.length){
        openBlocks[0].classList.remove("openFaq");
    }
    faqBlock.classList.toggle("openFaq")
    }
